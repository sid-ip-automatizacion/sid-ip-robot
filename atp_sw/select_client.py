...
"""
Este módulo lo saqué de lo que había hecho Richi
Recibe la información de Organización y ID en formato [(org,id),(),...]
Genera una lista de selección 
Devuelve el id de la Organización seleccionada
"""
